...
const ImportationtModal = ({
  open,
  onClose,
  integratedImportId,
  integratedImportCopy,
}) => {
  ...
  useEffect(() => {
    ...
    if (integratedImportCopy) {
      ...
      setConnection(
        integratedImportCopy.whatsappIds
          ? integratedImportCopy.whatsappIds.split(",")
          : ["Todos"]
      );
  ...
  return (
    <div className={classes.root}>
      ...
      >
        Você realmente deseja copiar está importação? Ao realizar está ação,
        dará inicio a importação dos dados para realizar os disparos, deseja
        prosseguir?
      </ConfirmationModal>
      <Dialog
        open={open}
            ...
            <Paper className={classes.mainPaper} variant="outlined">
              ...
              <div className={classes.multFieldLine}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    handleDocumentNumberRelationChange(e);
                  }}
                />
              </div>
              <div className={classes.multFieldLine}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    handleTemplateRelationChange(e);
                  }}
                />
              </div>
              <div className={classes.multFieldLine}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    handleTemplateParamsRelationChange(e);
                  }}
                />
              </div>
              <div className={classes.multFieldLine}>
              ...
              <div className={classes.multFieldLine}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    handlePhoneNumberRelationChange(e);
                  }}
                />
              </div>
            </Paper>
