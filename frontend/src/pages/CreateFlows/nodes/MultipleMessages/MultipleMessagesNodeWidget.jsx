    ...
    return (
      <div>
        <Dialog
          ...
          scroll="paper"
        >
          <DialogTitle id="form-dialog-title">Multiple Messages</DialogTitle>
          <DialogContent>
                    ...
                    <div style={{ display: "flex" }}>
                      ...
                      <IconButton
                        onClick={() => {
                          ...
                          const deletedMessageIndex =
                            messages.indexOf(deletedMessage);
