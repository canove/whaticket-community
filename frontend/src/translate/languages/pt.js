  ...
  pt: {
    translations: {
      ...
      nodeReports: {
        ...
        exportCsv: "Exportar CSV",
        noFlow: "Sem Fluxo",
        flowNotFound: "Fluxo Não Econtrado",
      },
      ...
      generalReports: {
        ...
        table: {
          ...
          noWhats: "Sem Whatsapp",
          receivedMessages: "Mensagens Trafegadas Recebidas",
          sentMessages: "Mensagens Trafegadas Enviadas",
          total: "TOTAL",
        }
      },

      categoryReport: {
        title: "Relatório de Categoria",
        table: {
          name: "Nome",
          quantity: "Quantidade",
        },
      ...
      backendErrors: {
        ...
        ERR_DOUBLE_QUEUES: "Só uma fila permitida por número.",
